...
async function getLodestoneData (query: string) {
  ...
  $ = cheerio.load(JSON.parse((await get(`https://img.finalfantasyxiv.com/lds/pc/tooltip/1610435816/na/item/${data.item}.js`)).match(/^eorzeadb\.pushup\((.+)\)$/)[1]).html)
