...
;(async () => {
  ...
  function parseHookset (elem: cheerio.Cheerio<cheerio.Element>): 'Precision' | 'Powerful' | null {
    ...
    switch (imgSrc) {
      case '':
        return null
      case './Ocean Fishing Data_files/Untitled(9).png':
      case './Ocean Fishing Data_files/Untitled(118).png':
      case './Ocean Fishing Data_files/Untitled(196).png':
        return 'Precision'
      case './Ocean Fishing Data_files/Untitled(12).png':
      case './Ocean Fishing Data_files/Untitled(121).png':
      case './Ocean Fishing Data_files/Untitled(194).png':
        return 'Powerful'
      default:
